...
export const PersonalInfoCard = () => {
  return (
    <div className="personal-info text-[20px] bg-slate-400 max-w-md p-10 my-10 mx-auto flex flex-col flex-wrap justify-center items-center rounded-lg  drop-shadow-2xl">
      ...
      <h1 className="personal-info__name text-[22px] font-bold text-[#181818] ">Ulisses</h1>
      <p className="personal-info__user font-semibold text-[#181818]">Odisseu93</p>
      <p className="personal-info__user font-medium text-[#25316D] text-center">Desenvolvedor Frontend | <br />React.js | <br />Typescript | <br />Analista de Sistemas</p>
